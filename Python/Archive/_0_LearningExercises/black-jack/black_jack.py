...
def value_of_ace(card_one, card_two):
    ...
    return 11 if value_card_one + value_card_two+ 11 <= 21 and (value_card_one != 1 and value_card_two != 1) else 1 
...
def is_blackjack(card_one, card_two):
    ...
    return (value_card_one == 1 and value_card_two== 10 ) or ( value_card_one == 10 and value_card_two == 1 )
