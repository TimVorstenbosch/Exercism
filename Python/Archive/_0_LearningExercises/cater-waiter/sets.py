...
def categorize_dish(dish_name, dish_ingredients):
    ...
    category = ""
    cat_dict = { "VEGAN" : VEGAN, "VEGETARIAN" : VEGETARIAN, "KETO" : KETO, "PALEO" : PALEO, "OMNIVORE" : OMNIVORE}
...
def separate_appetizers(dishes, appetizers):
    ...
    return sorted(set(dishes).difference(set(appetizers)))


def singleton_ingredients(dishes, intersection_constant):
    ...
    return set(ChainMap(*dishes)).difference(intersection_constant)
